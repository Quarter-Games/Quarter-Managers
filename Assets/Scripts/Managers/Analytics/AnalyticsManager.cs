...
namespace QuarterAsset.Analytics
{
    abstract public class AnalyticsManager : SingletonManager<AnalyticsManager>
    {
        ...
        {
            var status = await SaveSystem.BasicSaveLoadManager.GetData(PlayerConsentKey, PlayerConsent);
        ...
        {
            PlayerConsent = status;
            SaveSystem.BasicSaveLoadManager.SetData(PlayerConsentKey, status);
